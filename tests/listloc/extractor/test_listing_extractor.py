...
class TestListingExtractor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.__LISTING_FILES_THAT_SHOULD_BE_CREATED = [
            os.path.join(self.__BASE_DIRECTORY_PATH, ListingConstants.LISTING_DIRECTORY_NAME, f"file1_listing{ListingConstants.LISTING_FILE_EXTENSION}"),
            os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", ListingConstants.LISTING_DIRECTORY_NAME, f"file1_listing{ListingConstants.LISTING_FILE_EXTENSION}"),
            os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", "dir2", ListingConstants.LISTING_DIRECTORY_NAME, f"file1_listing{ListingConstants.LISTING_FILE_EXTENSION}"),
            os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", "dir2", ListingConstants.LISTING_DIRECTORY_NAME, f"file2_listing{ListingConstants.LISTING_FILE_EXTENSION}"),
            os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", "dir3", "dir4", ListingConstants.LISTING_DIRECTORY_NAME, f"file1_listing{ListingConstants.LISTING_FILE_EXTENSION}"),
            os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", "dir3", "dir4", ListingConstants.LISTING_DIRECTORY_NAME, f"file2_listing{ListingConstants.LISTING_FILE_EXTENSION}")
            ]
        self.__logger = ActionLogger(self.__BASE_DIRECTORY_PATH)
        self.__listing_extractor = ListingExtractor(self.__BASE_DIRECTORY_PATH, self.__logger)
    ...
    def __create_listing_dir_containing_non_listing_file(self):
        unclean_listing_directory = os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", "dir2", ListingConstants.LISTING_DIRECTORY_NAME)
    ...
    def test_extract_all_listings(self):
        ...
        listing_directory_in_empty_dir = os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", "dir3", ListingConstants.LISTING_DIRECTORY_NAME)
    ...
    def test_clear_all_listing_extractions(self):
        ...
        non_listing_file_in_listing_dir = os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", "dir2", ListingConstants.LISTING_DIRECTORY_NAME, "not_a_listing.txt")
    ...
    def __listing_directories_that_should_be_deleted_after_clearing(self):
        LISTING_DIRECTORIES_THAT_SHOULD_BE_DELETED = [
            os.path.join(self.__BASE_DIRECTORY_PATH, ListingConstants.LISTING_DIRECTORY_NAME),
            os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", ListingConstants.LISTING_DIRECTORY_NAME),
            os.path.join(self.__BASE_DIRECTORY_PATH, "dir1", "dir3", "dir4", ListingConstants.LISTING_DIRECTORY_NAME),
            ]
