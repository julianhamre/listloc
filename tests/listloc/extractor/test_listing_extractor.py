...
class TestListingExtractor(BaseTestListingExtractor):
    ...
    def setUp(self):
        ...
        self._create_test_file_structure(self.__SUBDIRS, self.__FILES)
    ...
    def test_invalid_path(self):
        ...
        for path in invalid_paths:
            self.assertRaises(NotADirectoryError, ListingExtractor, *(path, self._context))
